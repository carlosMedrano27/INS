                ...
                <div class="block">
                    ...
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="sub" required name="subcat" onchange="CargarTalla(this.value);">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-9">
                                <input id="spinner" class="form-control" name="costo" required value="0"/>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-9">
                                <input id="spinner2" class="form-control" name="cantidad" required value="0"/>
                            </div>
                        </div>
                    </div>
                </div>

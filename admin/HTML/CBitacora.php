						...
						<div class="row">
							<div class="col-md-12">
                              ...
                              <tr>
                                  ...
                                  <th width="10%">Texto1</th>
                                  <th width="10%">Texto2</th>
                                  <th width="10%">Texto3</th>
                                  <th width="10%">Texto4</th>
                          ...
                          <tbody>
                            ...
                            $result = mysqli_query($conexion,"SELECT * FROM historial_carrusel");
  						              while($fila = mysqli_fetch_array($result))
  						                {
  						                  ?>
                              <tr>
                                  <td><?php echo $fila['cod_carrusel']; ?></td>
                                ...
                                if ($img=="") {
                                  ...
                                  ?>
                                  <td><center><img height="40px" width="40px" src="data:image/jpg;base64,<?php echo base64_encode($fila['Imagen']); ?> "/></center></td>
                                <?php
                                }
                                 ?> 

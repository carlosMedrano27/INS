      ...
      <div class="row">
        ...
        ?>
          ...
          <div class="col-md-5">
            ...
            $cod=$_REQUEST['Cod'];
            $result = mysqli_query($conexion,"SELECT * FROM carrusel Where Codigo='$cod'");
            while($fila = mysqli_fetch_array($result))
              {
                ?>
             <form method="post" action="GCarrusel.php?Cod=<?php echo $fila['Codigo']; ?>" enctype="multipart/form-data">
                ...
                <div class="block">
                    ...
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">Texto 4:</div>
                            <div class="col-md-10"><input type="text" class="form-control" input type="text" name="texto4" value="<?php echo $fila['Texto4']; ?>" placeholder="Introducir Texto" rows="3"></div>
                        </div>
          ...
          <div class="col-md-5">
            ...
            <form method="post" action="GICarrusel.php?Cod=<?php echo $fila['Codigo']; ?>" enctype="multipart/form-data">
                <div class="block">
                    <div class="header">

          ...
          <div class="col-md-12">
            <table class="table table-sorting table-striped table-hover datatable" id="resultados">  <thead>
                          <tr>
                              ...
                              <th width="20%">Texto 1</th>
                              <th width="20%">Texto 2</th>
                              <th width="20%">Texto 3</th>
                      ...
                      <tbody>
                        ...
                        $result = mysqli_query($conexion,"SELECT * FROM onepage order by Codigo");
                        while($fila = mysqli_fetch_array($result))
                          ...
                          <tr>
                              ...
                              <td><center><a href="Onepage.php?Cod=<?php echo $fila['Codigo']; ?>"><button type="button" class="btn btn-info btn-xs">

	...
	<footer class="footer">
		<div class="container">
			...
			<div class="row">
				<div class="col">
					<!-- Copyright -->
					<div class="footer_cr_2">2019 Todos los derechos reservados</div>
				</div>
			</div>
		</div>
	</footer>
...
<script src="user/plugins/slick-1.8.0/slick.js"></script>
<script src="user/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="user/plugins/scrollTo/jquery.scrollTo.min.js"></script>
